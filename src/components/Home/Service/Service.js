    ...
    return (
        <Col>
            <Card className="bg-dark text-white h-100 card shadow  bg-body rounded" style={{ borderRadius: '15px' }}>
                <Card.Img src={service.img} alt="Card image" style={{ height: '400px', borderRadius: '15px' }} className="image-fluid" />
                <Card.ImgOverlay className="service-centered">
                    <Card.Title className="text-white fw-bold text-start fs-3 image-text-background pb-2" >{service.name}</Card.Title>
